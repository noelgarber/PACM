...
def find_optimal_weights(dens_df, slim_length, position_copies, matrices_dict, sequence_col, significance_col,
    ...
    results = process_weights(weights_array_chunks, matrices_dict, slim_length, sequence_col, significance_col, output_df)

    for result in results:
        current_best_fdr, current_best_for, current_best_score, weights_list, current_weighted_matrices_dict, output_df = result
        if not np.isnan(current_best_fdr) and not np.isnan(current_best_for):
            if current_best_fdr < best_fdr:
                ...
                best_weights, best_weighted_matrices_dict, best_dens_df = weights_list, current_weighted_matrices_dict, output_df
