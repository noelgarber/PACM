...
image_params = {"use_cached_data": False,
                ...
                "output_folder": "/home/user/Sharpened and Cleaned/Image_Data",
                "add_peptide_seqs": True,
                "peptide_seq_cols": ["Phos_Sequence", "No_Phos_Sequence", "BJO_Sequence"],
                "save_pickled_data": True,
                "buffer_width": 2,
                "tiff_paths": ["/home/user/Sharpened and Cleaned/Group_1",
                               "/home/user/Sharpened and Cleaned/Group_2"],
                "pixel_encoding_base": 1,
                "add_peptide_names": True,
                "multiline_cols": False,
                "peptide_names_paths": ["/home/user/Sharpened and Cleaned/Group_1_Coordinate_Peptide_Names_and_Sequences.csv",
                                        "/home/user/Sharpened and Cleaned/Group_2_Coordinate_Peptide_Names_and_Sequences.csv"],
                "processed_image_paths": ["/home/user/Sharpened and Cleaned/Image_Data/Group_1",
                                          "/home/user/Sharpened and Cleaned/Image_Data/Group_2"],
...
general_params = {"motif_length": 15,
                  "output_folder": "/home/user/Sharpened and Cleaned/Matrix_Data",
                  "make_calls": True,
...
matrix_params = {"thresholds_points_dict": None,
                 ...
                 "min_members": 24,
                 "generate_individual_regressions": False,
                 "mann_whitney_alpha": 1,
                 "min_aa_entries": 5,
                 "barnard_alpha": 1,
                 "always_assign_suboptimal": False,
                 "ignore_failed_peptides": True,
                 "preview_positive_scatter_plot": False,
                 "replace_forbidden": False,
                 "suppress_positive_positions": np.array([11,14]),
                 "suppress_suboptimal_positions": np.array([11,14]),
                 "suppress_forbidden_positions": np.array([0,1,2,3,4,11,13,14]),
                 ...
                 "position_weights": np.array([0.5,0.5,0.5,0.5,0.5,
                                               ...
                                               1,
                                               0,0]),
                 "forbidden_threshold": 8,
                 "forced_required_dict": {7: ("F", "Y"),
                                          9: ("D","E","S","T","B","J")}}
